...
const Footer = () => {
    return (
        <footer className="py-6 bg-[#2B262D] dark:text-white">
		...
		<div className="grid grid-cols-12">
			<div className="pb-6 col-span-full md:pb-0 md:col-span-6">
				<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
					...
					<span className="self-center text-2xl font-semibold">LuxuryLair</span>
				</a>
                    <div className="ml-4 mt-3 space-y-3">
                    <span className="flex items-center gap-2"><GrLocation />1889 NW 79st St, Asheville, NC 98726</span>
                    <span className="flex items-center gap-2"><MdLocalPhone />11223 543 5432</span>
                    <span className="flex items-center gap-2"><TfiEmail />inquiry@luxurylair.com</span>
                    </div>
			</div>
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				...
				<ul>
					...
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Update Profile</a>
					</li>
				</ul>
			</div>
			<div className="col-span-6 text-center md:text-left md:col-span-3">
				...
				<ul>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Agents</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Agencies</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Blog</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">FAQs</a>
					</li>
					<li>
