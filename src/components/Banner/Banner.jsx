...
const Banner = () => {
    return (
       <div className="bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('bg3.avif')] h-full py-10 md:py-20 bg-cover bg-no-repeat bg-center  flex  items-center rounded-md md:rounded-none shadow-lg">
